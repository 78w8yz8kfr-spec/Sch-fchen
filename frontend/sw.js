const CACHE_NAME = "schaefchen-online-v87";
...
const APP_SHELL = [
  ...
  "./index.html",
  "./styles.css?v=0.44.5",
  "./design-system.css?v=0.44.5",
  "./app.js?v=0.44.5",
  "./core/work-time.js?v=0.44.5",
  "./core/sync-queue.js?v=0.44.5",
  "./core/permissions.js?v=0.44.5",
  "./core/state-store.js?v=0.44.5",
  "./core/versions.js?v=0.44.5",
  "./core/device-management.js?v=0.44.5",
  "./core/apprentice-view.js?v=0.44.5",
  "./vendor/qr-scanner.min.js?v=0.44.5",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.5",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.5",
  "./platform-admin.js?v=0.44.5",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.5",
  "./vde/app.js?v=0.44.5",
