...
const APP_SHELL = [
  ...
  "./index.html",
  "./styles.css?v=0.45.0",
  "./design-system.css?v=0.45.0",
  "./app.js?v=0.45.0",
  "./core/work-time.js?v=0.45.0",
  "./core/sync-queue.js?v=0.45.0",
  "./core/permissions.js?v=0.45.0",
  "./core/state-store.js?v=0.45.0",
  "./core/versions.js?v=0.45.0",
  "./core/device-management.js?v=0.45.0",
  "./core/power-module.js?v=0.45.0",
  "./core/apprentice-view.js?v=0.45.0",
  "./print-devices.css?v=0.45.0",
  "./vendor/qr-scanner.min.js?v=0.45.0",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.45.0",
  "./platform-admin.html",
  "./platform-admin.css?v=0.45.0",
  "./platform-admin.js?v=0.45.0",
  "./vde/index.html",
  "./vde/styles.css?v=0.45.0",
  "./vde/app.js?v=0.45.0",
