const CACHE_NAME = "schaefchen-online-v131";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.49",
  "./design-system.css?v=0.44.49",
  "./app.js?v=0.44.49",
  "./core/work-time.js?v=0.44.49",
  "./core/sync-queue.js?v=0.44.49",
  "./core/permissions.js?v=0.44.49",
  "./core/state-store.js?v=0.44.49",
  "./core/versions.js?v=0.44.49",
  "./core/device-management.js?v=0.44.49",
  "./core/power-module.js?v=0.44.49",
  "./core/apprentice-view.js?v=0.44.49",
  "./core/time-changes.js?v=0.44.49",
  "./print-devices.css?v=0.44.49",
  "./vendor/qr-scanner.min.js?v=0.44.49",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.49",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.49",
  "./platform-admin.js?v=0.44.49",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.49",
  "./vde/app.js?v=0.44.49",
