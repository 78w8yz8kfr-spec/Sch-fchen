const CACHE_NAME = "schaefchen-online-v88";
...
const APP_SHELL = [
  ...
  "./index.html",
  "./styles.css?v=0.44.6",
  "./design-system.css?v=0.44.6",
  "./app.js?v=0.44.6",
  "./core/work-time.js?v=0.44.6",
  "./core/sync-queue.js?v=0.44.6",
  "./core/permissions.js?v=0.44.6",
  "./core/state-store.js?v=0.44.6",
  "./core/versions.js?v=0.44.6",
  "./core/device-management.js?v=0.44.6",
  "./core/apprentice-view.js?v=0.44.6",
  "./vendor/qr-scanner.min.js?v=0.44.6",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.6",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.6",
  "./platform-admin.js?v=0.44.6",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.6",
  "./vde/app.js?v=0.44.6",
