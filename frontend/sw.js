const CACHE_NAME = "schaefchen-online-v121";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.39",
  "./design-system.css?v=0.44.39",
  "./app.js?v=0.44.39",
  "./core/work-time.js?v=0.44.39",
  "./core/sync-queue.js?v=0.44.39",
  "./core/permissions.js?v=0.44.39",
  "./core/state-store.js?v=0.44.39",
  "./core/versions.js?v=0.44.39",
  "./core/device-management.js?v=0.44.39",
  "./core/power-module.js?v=0.44.39",
  "./core/apprentice-view.js?v=0.44.39",
  "./print-devices.css?v=0.44.39",
  "./vendor/qr-scanner.min.js?v=0.44.39",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.39",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.39",
  "./platform-admin.js?v=0.44.39",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.39",
  "./vde/app.js?v=0.44.39",
