const CACHE_NAME = "schaefchen-online-v124";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.42",
  "./design-system.css?v=0.44.42",
  "./app.js?v=0.44.42",
  "./core/work-time.js?v=0.44.42",
  "./core/sync-queue.js?v=0.44.42",
  "./core/permissions.js?v=0.44.42",
  "./core/state-store.js?v=0.44.42",
  "./core/versions.js?v=0.44.42",
  "./core/device-management.js?v=0.44.42",
  "./core/power-module.js?v=0.44.42",
  "./core/apprentice-view.js?v=0.44.42",
  "./core/time-changes.js?v=0.44.42",
  "./print-devices.css?v=0.44.42",
  "./vendor/qr-scanner.min.js?v=0.44.42",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.42",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.42",
  "./platform-admin.js?v=0.44.42",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.42",
  "./vde/app.js?v=0.44.42",
