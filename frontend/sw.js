const CACHE_NAME = "schaefchen-online-v130";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.48",
  "./design-system.css?v=0.44.48",
  "./app.js?v=0.44.48",
  "./core/work-time.js?v=0.44.48",
  "./core/sync-queue.js?v=0.44.48",
  "./core/permissions.js?v=0.44.48",
  "./core/state-store.js?v=0.44.48",
  "./core/versions.js?v=0.44.48",
  "./core/device-management.js?v=0.44.48",
  "./core/power-module.js?v=0.44.48",
  "./core/apprentice-view.js?v=0.44.48",
  "./core/time-changes.js?v=0.44.48",
  "./print-devices.css?v=0.44.48",
  "./vendor/qr-scanner.min.js?v=0.44.48",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.48",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.48",
  "./platform-admin.js?v=0.44.48",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.48",
  "./vde/app.js?v=0.44.48",
