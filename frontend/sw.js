const CACHE_NAME = "schaefchen-online-v95";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.13",
  "./design-system.css?v=0.44.13",
  "./app.js?v=0.44.13",
  "./core/work-time.js?v=0.44.13",
  "./core/sync-queue.js?v=0.44.13",
  "./core/permissions.js?v=0.44.13",
  "./core/state-store.js?v=0.44.13",
  "./core/versions.js?v=0.44.13",
  "./core/device-management.js?v=0.44.13",
  "./core/apprentice-view.js?v=0.44.13",
  "./core/stock-module.js?v=0.44.13",
  "./core/stock-management.js?v=0.44.13",
  "./core/barcode-scanner.mjs?v=0.44.13",
  "./core/barcode-decoder.mjs",
  "./print-labels.css?v=0.44.13",
  "./print-devices.css?v=0.44.13",
  "./vendor/qr-scanner.min.js?v=0.44.13",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.13",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.13",
  "./platform-admin.js?v=0.44.13",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.13",
  "./vde/app.js?v=0.44.13",
