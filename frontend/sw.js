const CACHE_NAME = "schaefchen-online-v117";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.35",
  "./design-system.css?v=0.44.35",
  "./app.js?v=0.44.35",
  "./core/work-time.js?v=0.44.35",
  "./core/sync-queue.js?v=0.44.35",
  "./core/permissions.js?v=0.44.35",
  "./core/state-store.js?v=0.44.35",
  "./core/versions.js?v=0.44.35",
  "./core/device-management.js?v=0.44.35",
  "./core/apprentice-view.js?v=0.44.35",
  "./print-devices.css?v=0.44.35",
  "./vendor/qr-scanner.min.js?v=0.44.35",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.35",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.35",
  "./platform-admin.js?v=0.44.35",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.35",
  "./vde/app.js?v=0.44.35",
