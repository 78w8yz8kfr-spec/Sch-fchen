const CACHE_NAME = "schaefchen-online-v98";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.16",
  "./design-system.css?v=0.44.16",
  "./app.js?v=0.44.16",
  "./core/work-time.js?v=0.44.16",
  "./core/sync-queue.js?v=0.44.16",
  "./core/permissions.js?v=0.44.16",
  "./core/state-store.js?v=0.44.16",
  "./core/versions.js?v=0.44.16",
  "./core/device-management.js?v=0.44.16",
  "./core/apprentice-view.js?v=0.44.16",
  "./core/stock-module.js?v=0.44.16",
  "./core/stock-management.js?v=0.44.16",
  "./core/barcode-scanner.mjs?v=0.44.16",
  "./core/barcode-decoder.mjs",
  "./print-labels.css?v=0.44.16",
  "./print-devices.css?v=0.44.16",
  "./vendor/qr-scanner.min.js?v=0.44.16",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.16",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.16",
  "./platform-admin.js?v=0.44.16",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.16",
  "./vde/app.js?v=0.44.16",
