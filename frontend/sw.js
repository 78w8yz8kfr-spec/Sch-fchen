const CACHE_NAME = "schaefchen-online-v99";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.17",
  "./design-system.css?v=0.44.17",
  "./app.js?v=0.44.17",
  "./core/work-time.js?v=0.44.17",
  "./core/sync-queue.js?v=0.44.17",
  "./core/permissions.js?v=0.44.17",
  "./core/state-store.js?v=0.44.17",
  "./core/versions.js?v=0.44.17",
  "./core/device-management.js?v=0.44.17",
  "./core/apprentice-view.js?v=0.44.17",
  "./core/stock-module.js?v=0.44.17",
  "./core/stock-management.js?v=0.44.17",
  "./core/barcode-scanner.mjs?v=0.44.17",
  "./core/barcode-decoder.mjs",
  "./print-labels.css?v=0.44.17",
  "./print-devices.css?v=0.44.17",
  "./vendor/qr-scanner.min.js?v=0.44.17",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.17",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.17",
  "./platform-admin.js?v=0.44.17",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.17",
  "./vde/app.js?v=0.44.17",
