const CACHE_NAME = "schaefchen-online-v103";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.21",
  "./design-system.css?v=0.44.21",
  "./app.js?v=0.44.21",
  "./core/work-time.js?v=0.44.21",
  "./core/sync-queue.js?v=0.44.21",
  "./core/permissions.js?v=0.44.21",
  "./core/state-store.js?v=0.44.21",
  "./core/versions.js?v=0.44.21",
  "./core/device-management.js?v=0.44.21",
  "./core/apprentice-view.js?v=0.44.21",
  "./core/stock-module.js?v=0.44.21",
  "./core/stock-management.js?v=0.44.21",
  "./core/barcode-scanner.mjs?v=0.44.21",
  "./core/barcode-decoder.mjs",
  "./print-labels.css?v=0.44.21",
  "./print-devices.css?v=0.44.21",
  "./vendor/qr-scanner.min.js?v=0.44.21",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.21",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.21",
  "./platform-admin.js?v=0.44.21",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.21",
  "./vde/app.js?v=0.44.21",
