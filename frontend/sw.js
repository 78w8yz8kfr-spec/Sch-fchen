const CACHE_NAME = "schaefchen-online-v104";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.22",
  "./design-system.css?v=0.44.22",
  "./app.js?v=0.44.22",
  "./core/work-time.js?v=0.44.22",
  "./core/sync-queue.js?v=0.44.22",
  "./core/permissions.js?v=0.44.22",
  "./core/state-store.js?v=0.44.22",
  "./core/versions.js?v=0.44.22",
  "./core/device-management.js?v=0.44.22",
  "./core/apprentice-view.js?v=0.44.22",
  "./core/stock-module.js?v=0.44.22",
  "./core/stock-management.js?v=0.44.22",
  "./core/barcode-scanner.mjs?v=0.44.22",
  "./core/barcode-decoder.mjs",
  "./print-labels.css?v=0.44.22",
  "./print-devices.css?v=0.44.22",
  "./vendor/qr-scanner.min.js?v=0.44.22",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.22",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.22",
  "./platform-admin.js?v=0.44.22",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.22",
  "./vde/app.js?v=0.44.22",
