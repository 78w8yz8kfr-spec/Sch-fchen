const CACHE_NAME = "schaefchen-online-v83";
...
const APP_SHELL = [
  ...
  "./index.html",
  "./styles.css?v=0.44.1",
  "./design-system.css?v=0.44.1",
  "./app.js?v=0.44.1",
  "./core/work-time.js?v=0.44.1",
  "./core/sync-queue.js?v=0.44.1",
  "./core/permissions.js?v=0.44.1",
  "./core/state-store.js?v=0.44.1",
  "./core/versions.js?v=0.44.1",
  "./core/device-management.js?v=0.44.1",
  "./vendor/qr-scanner.min.js?v=0.44.1",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.1",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.1",
  "./platform-admin.js?v=0.44.1",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.1",
  "./vde/app.js?v=0.44.1",
