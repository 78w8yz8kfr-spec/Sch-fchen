const CACHE_NAME = "schaefchen-online-v97";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.15",
  "./design-system.css?v=0.44.15",
  "./app.js?v=0.44.15",
  "./core/work-time.js?v=0.44.15",
  "./core/sync-queue.js?v=0.44.15",
  "./core/permissions.js?v=0.44.15",
  "./core/state-store.js?v=0.44.15",
  "./core/versions.js?v=0.44.15",
  "./core/device-management.js?v=0.44.15",
  "./core/apprentice-view.js?v=0.44.15",
  "./core/stock-module.js?v=0.44.15",
  "./core/stock-management.js?v=0.44.15",
  "./core/barcode-scanner.mjs?v=0.44.15",
  "./core/barcode-decoder.mjs",
  "./print-labels.css?v=0.44.15",
  "./print-devices.css?v=0.44.15",
  "./vendor/qr-scanner.min.js?v=0.44.15",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.15",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.15",
  "./platform-admin.js?v=0.44.15",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.15",
  "./vde/app.js?v=0.44.15",
