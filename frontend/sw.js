const CACHE_NAME = "schaefchen-online-v85";
...
const APP_SHELL = [
  ...
  "./index.html",
  "./styles.css?v=0.44.3",
  "./design-system.css?v=0.44.3",
  "./app.js?v=0.44.3",
  "./core/work-time.js?v=0.44.3",
  "./core/sync-queue.js?v=0.44.3",
  "./core/permissions.js?v=0.44.3",
  "./core/state-store.js?v=0.44.3",
  "./core/versions.js?v=0.44.3",
  "./core/device-management.js?v=0.44.3",
  "./vendor/qr-scanner.min.js?v=0.44.3",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.3",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.3",
  "./platform-admin.js?v=0.44.3",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.3",
  "./vde/app.js?v=0.44.3",
