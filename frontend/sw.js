const CACHE_NAME = "schaefchen-online-v72";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.42.30",
  "./app.js?v=0.42.30",
  "./core/work-time.js?v=0.42.30",
  "./core/sync-queue.js?v=0.42.30",
  "./core/permissions.js?v=0.42.30",
  "./core/state-store.js?v=0.42.30",
  "./core/versions.js?v=0.42.30",
  "./version.js?v=0.42.30",
  "./platform-admin.html",
  "./platform-admin.css?v=0.42.30",
  "./platform-admin.js?v=0.42.30",
  "./vde/index.html",
  "./vde/styles.css?v=0.42.30",
  "./vde/app.js?v=0.42.30",
