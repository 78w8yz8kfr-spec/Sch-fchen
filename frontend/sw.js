const CACHE_NAME = "schaefchen-online-v90";
...
const APP_SHELL = [
  ...
  "./index.html",
  "./styles.css?v=0.44.8",
  "./design-system.css?v=0.44.8",
  "./app.js?v=0.44.8",
  "./core/work-time.js?v=0.44.8",
  "./core/sync-queue.js?v=0.44.8",
  "./core/permissions.js?v=0.44.8",
  "./core/state-store.js?v=0.44.8",
  "./core/versions.js?v=0.44.8",
  "./core/device-management.js?v=0.44.8",
  "./core/apprentice-view.js?v=0.44.8",
  "./vendor/qr-scanner.min.js?v=0.44.8",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.8",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.8",
  "./platform-admin.js?v=0.44.8",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.8",
  "./vde/app.js?v=0.44.8",
