const CACHE_NAME = "schaefchen-online-v96";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.14",
  "./design-system.css?v=0.44.14",
  "./app.js?v=0.44.14",
  "./core/work-time.js?v=0.44.14",
  "./core/sync-queue.js?v=0.44.14",
  "./core/permissions.js?v=0.44.14",
  "./core/state-store.js?v=0.44.14",
  "./core/versions.js?v=0.44.14",
  "./core/device-management.js?v=0.44.14",
  "./core/apprentice-view.js?v=0.44.14",
  "./core/stock-module.js?v=0.44.14",
  "./core/stock-management.js?v=0.44.14",
  "./core/barcode-scanner.mjs?v=0.44.14",
  "./core/barcode-decoder.mjs",
  "./print-labels.css?v=0.44.14",
  "./print-devices.css?v=0.44.14",
  "./vendor/qr-scanner.min.js?v=0.44.14",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.14",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.14",
  "./platform-admin.js?v=0.44.14",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.14",
  "./vde/app.js?v=0.44.14",
