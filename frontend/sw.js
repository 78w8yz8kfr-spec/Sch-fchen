const CACHE_NAME = "schaefchen-online-v119";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.37",
  "./design-system.css?v=0.44.37",
  "./app.js?v=0.44.37",
  "./core/work-time.js?v=0.44.37",
  "./core/sync-queue.js?v=0.44.37",
  "./core/permissions.js?v=0.44.37",
  "./core/state-store.js?v=0.44.37",
  "./core/versions.js?v=0.44.37",
  "./core/device-management.js?v=0.44.37",
  "./core/power-module.js?v=0.44.37",
  "./core/apprentice-view.js?v=0.44.37",
  "./print-devices.css?v=0.44.37",
  "./vendor/qr-scanner.min.js?v=0.44.37",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.37",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.37",
  "./platform-admin.js?v=0.44.37",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.37",
  "./vde/app.js?v=0.44.37",
