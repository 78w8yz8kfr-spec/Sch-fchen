const CACHE_NAME = "schaefchen-online-v86";
...
const APP_SHELL = [
  ...
  "./index.html",
  "./styles.css?v=0.44.4",
  "./design-system.css?v=0.44.4",
  "./app.js?v=0.44.4",
  "./core/work-time.js?v=0.44.4",
  "./core/sync-queue.js?v=0.44.4",
  "./core/permissions.js?v=0.44.4",
  "./core/state-store.js?v=0.44.4",
  "./core/versions.js?v=0.44.4",
  "./core/device-management.js?v=0.44.4",
  "./core/apprentice-view.js?v=0.44.4",
  "./vendor/qr-scanner.min.js?v=0.44.4",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.4",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.4",
  "./platform-admin.js?v=0.44.4",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.4",
  "./vde/app.js?v=0.44.4",
