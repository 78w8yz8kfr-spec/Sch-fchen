const CACHE_NAME = "schaefchen-online-v84";
...
const APP_SHELL = [
  ...
  "./index.html",
  "./styles.css?v=0.44.2",
  "./design-system.css?v=0.44.2",
  "./app.js?v=0.44.2",
  "./core/work-time.js?v=0.44.2",
  "./core/sync-queue.js?v=0.44.2",
  "./core/permissions.js?v=0.44.2",
  "./core/state-store.js?v=0.44.2",
  "./core/versions.js?v=0.44.2",
  "./core/device-management.js?v=0.44.2",
  "./vendor/qr-scanner.min.js?v=0.44.2",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.2",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.2",
  "./platform-admin.js?v=0.44.2",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.2",
  "./vde/app.js?v=0.44.2",
