const CACHE_NAME = "schaefchen-online-v94";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.44.12",
  "./design-system.css?v=0.44.12",
  "./app.js?v=0.44.12",
  "./core/work-time.js?v=0.44.12",
  "./core/sync-queue.js?v=0.44.12",
  "./core/permissions.js?v=0.44.12",
  "./core/state-store.js?v=0.44.12",
  "./core/versions.js?v=0.44.12",
  "./core/device-management.js?v=0.44.12",
  "./core/apprentice-view.js?v=0.44.12",
  "./core/stock-module.js?v=0.44.12",
  "./core/stock-management.js?v=0.44.12",
  "./core/barcode-scanner.mjs?v=0.44.12",
  "./core/barcode-decoder.mjs",
  "./vendor/qr-scanner.min.js?v=0.44.12",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.12",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.12",
  "./platform-admin.js?v=0.44.12",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.12",
  "./vde/app.js?v=0.44.12",
