const CACHE_NAME = "schaefchen-online-v89";
...
const APP_SHELL = [
  ...
  "./index.html",
  "./styles.css?v=0.44.7",
  "./design-system.css?v=0.44.7",
  "./app.js?v=0.44.7",
  "./core/work-time.js?v=0.44.7",
  "./core/sync-queue.js?v=0.44.7",
  "./core/permissions.js?v=0.44.7",
  "./core/state-store.js?v=0.44.7",
  "./core/versions.js?v=0.44.7",
  "./core/device-management.js?v=0.44.7",
  "./core/apprentice-view.js?v=0.44.7",
  "./vendor/qr-scanner.min.js?v=0.44.7",
  "./vendor/qr-scanner-worker.min.js",
  "./version.js?v=0.44.7",
  "./platform-admin.html",
  "./platform-admin.css?v=0.44.7",
  "./platform-admin.js?v=0.44.7",
  "./vde/index.html",
  "./vde/styles.css?v=0.44.7",
  "./vde/app.js?v=0.44.7",
