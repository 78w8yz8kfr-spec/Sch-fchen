const CACHE_NAME = "schaefchen-online-v67";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.42.25",
  "./app.js?v=0.42.25",
  "./core/work-time.js?v=0.42.25",
  "./core/sync-queue.js?v=0.42.25",
  "./core/permissions.js?v=0.42.25",
  "./core/state-store.js?v=0.42.25",
  "./version.js?v=0.42.25",
  "./platform-admin.html",
  "./platform-admin.css?v=0.42.25",
  "./platform-admin.js?v=0.42.25",
  "./vde/index.html",
  "./vde/styles.css?v=0.42.25",
  "./vde/app.js?v=0.42.25",
