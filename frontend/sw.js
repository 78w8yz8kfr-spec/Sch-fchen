const CACHE_NAME = "schaefchen-online-v71";
const DOCUMENT_CACHE_VERSION = "v42";
const DOCUMENT_CACHE_PREFIX = `schaefchen-documents-${DOCUMENT_CACHE_VERSION}-`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=0.42.29",
  "./app.js?v=0.42.29",
  "./core/work-time.js?v=0.42.29",
  "./core/sync-queue.js?v=0.42.29",
  "./core/permissions.js?v=0.42.29",
  "./core/state-store.js?v=0.42.29",
  "./core/versions.js?v=0.42.29",
  "./version.js?v=0.42.29",
  "./platform-admin.html",
  "./platform-admin.css?v=0.42.29",
  "./platform-admin.js?v=0.42.29",
  "./vde/index.html",
  "./vde/styles.css?v=0.42.29",
  "./vde/app.js?v=0.42.29",
